...
<head>
	<meta charset="UTF-8">
	<title>Isreal Bubble Ball</title>
		...
		<?php include("navbar.php"); ?>
			<div id="videoContainer">
				...
				<div dir="rtl" id="videoText">
					...
					<br>חוויה בלתי נשכחת שתשאיר לכם חיוך לאורך זמן!
				</p></h2>
				...
				<div class="container">
					<div class="row">
						...
						<div class=" question">
							...
							<p>לקראית התקנון <a href="policy.html">לחץ כאן</a> </p>
						</div>
						<div class=" question">
							<h2>איך עושים הזמנה?</h2>
							<p>להסבר על הזמנות ורכישות ,<a href="buy.php">לחץ כאן</a> </p>
						</div>
